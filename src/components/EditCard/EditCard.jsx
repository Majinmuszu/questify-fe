              ...
              <div>
                ...
                <div className={isDiffActive ? s.level__dropdown : s.hidden}>
                  ...
                  <input
                    ...
                    name="difficulty"
                    value="easy"
                    defaultChecked={defaultDifficulty === "easy" ? true : false}
                  ...
                  <input
                    ...
                    value="normal"
                    defaultChecked={
                      defaultDifficulty === "normal" ? true : false
                    }
                    onClick={handleDiffRadio}
                  />
                  ...
                  <input
                    ...
                    name="difficulty"
                    value="hard"
                    defaultChecked={defaultDifficulty === "hard" ? true : false}
                    onClick={handleDiffRadio}
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className={isCatActive ? s.category__dropdown : s.hidden}>
                  ...
                  <input
                    ...
                    name="category"
                    value="stuff"
                    defaultChecked={defaultCategory === "stuff" ? true : false}
                  ...
                  <input
                    ...
                    name="category"
                    value="family"
                    defaultChecked={defaultCategory === "family" ? true : false}
                    onClick={handleCatRadio}
                  />
                  ...
                  <input
                    ...
                    name="category"
                    value="health"
                    defaultChecked={defaultCategory === "health" ? true : false}
                    onClick={handleCatRadio}
                  />
                  ...
                  <input
                    ...
                    value="learning"
                    defaultChecked={
                      defaultCategory === "learning" ? true : false
                    }
                    onClick={handleCatRadio}
                  />
                  ...
                  <input
                    ...
                    value="leisure"
                    defaultChecked={
                      defaultCategory === "leisure" ? true : false
                    }
                    onClick={handleCatRadio}
                  />
                  ...
                  <input
                    ...
                    name="category"
                    value="work"
                    defaultChecked={defaultCategory === "work" ? true : false}
                    onClick={handleCatRadio}
                  />
                </div>
              </div>
